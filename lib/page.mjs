...
function renderTopNav() {
  ...
  <div class="ac-nav-inner">
    <a href="/" class="ac-brand" aria-label="AgentCanary home">
      <div class="ac-brand-dot"></div>
      <div class="ac-brand-text">Agent<span class="ac-brand-accent">Canary</span></div>
    </a>
  ...
  return wrapPage({
    ...
    bodyHtml: `
      <div class="ac-hero">
        ...
        <h1>The Record</h1>
        <p class="ac-hero-sub">Daily macro briefs with regime tracking, narrative momentum, and public track-record-verified predictions. Every brief permanently archived.</p>
      </div>
